...
set GLUT_ROOT=F:\Tech Zone\Abhishek_LRC\Third_Party\freeglut
set GLUT_PATH=%GLUT_ROOT%\VS2012\bin\x86\
set GLUT_LIB=%GLUT_ROOT%\VS2012\lib\x86\
set GLUT_INCLUDE=%GLUT_ROOT%\include\

set PATH=%PATH%;%OPENCV_PATH%;%TBB_PATH%;%GLUT_PATH%

::ContrastEnhancement.sln